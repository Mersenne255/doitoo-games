      ...
      @if (result(); as r) {
        ...
        <div class="slots">
          <div class="slot-result">
            <span class="slot-title">{{ r.puzzleAccuracy | number:'1.0-0' }}%</span>
            <span class="slot-label">Puzzle Accuracy</span>
          </div>
          <div class="slot-result">
            <span class="slot-title">{{ r.cellAccuracy | number:'1.0-0' }}%</span>
            <span class="slot-label">Cell Accuracy</span>
          </div>
          <div class="slot-result">
            <span class="slot-title correct">✓ {{ r.perfectCount }}</span>
            <span class="slot-label">Perfect</span>
          </div>
          <div class="slot-result">
            <span class="slot-title incorrect">✗ {{ r.imperfectCount }}</span>
            <span class="slot-label">Imperfect</span>
          </div>
          <div class="slot-result">
            <span class="slot-title">{{ formatTime(r.averageSolveTimeMs) }}s</span>
