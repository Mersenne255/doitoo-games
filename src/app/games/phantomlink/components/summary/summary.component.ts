...
@Component({
    ...
    <div class="summary-card">
      ...
      @if (result(); as r) {
        ...
        <div class="slots">
          ...
          <div class="slot-result">
            <span class="slot-title phantom">👻 {{ r.phantomErrorCount }}</span>
            <span class="slot-label">Phantom Errors</span>
          </div>
          <div class="slot-result">
            <span class="slot-title phantom">{{ r.phantomResistanceRate | number:'1.0-0' }}%</span>
            <span class="slot-label">Phantom Resistance</span>
          </div>
          <div class="slot-result">
            <span class="slot-title">{{ r.symbolCount }}</span>
            <span class="slot-label">Symbols</span>
          </div>
        </div>
      }
  ...
  styles: [`
    ...
    .slot-title.phantom { color: #c084fc; }
