...
@Component({
  ...
  template: `
    ...
    @if (game.stage() === 'summary') {
      <app-matrixiq-summary [result]="game.roundResult()!" (back)="game.goToIdle()" (playAgain)="game.startSession()" />
    }
  `,
  styles: [`
    :host {
...
export class MatrixiqGameComponent implements OnInit, OnDestroy {
