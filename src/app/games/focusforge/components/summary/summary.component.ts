...
@Component({
  selector: 'app-focusforge-summary',
  standalone: true,
  imports: [DecimalPipe],
    ...
    <div class="summary-card">
      ...
      @if (result(); as r) {
        ...
        <div class="slots">
          ...
          <div class="slot-result">
            <span class="slot-title muted">⏱ {{ r.timedOutCount }}</span>
          ...
          <div class="slot-result">
            <span class="slot-title">{{ r.averageFeatureSearchMs | number:'1.0-0' }}ms</span>
            <span class="slot-label">Pop-out</span>
          </div>
          <div class="slot-result">
            <span class="slot-title">{{ r.averageConjunctionSearchMs | number:'1.0-0' }}ms</span>
            <span class="slot-label">Conjunction</span>
          </div>
          <div class="slot-result">
